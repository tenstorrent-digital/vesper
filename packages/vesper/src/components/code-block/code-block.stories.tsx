...
const SAMPLE_CODE_CSS = `/* CSS Component Styles */
:root {
...
const SAMPLE_CODE_MARKDOWN = `# Design System Documentation
...
const SAMPLE_CODE_BASH = `#!/usr/bin/env bash
