---
title: Choicebox
description: A card-style selection component supporting both single-select (radio) and multi-select (checkbox) modes.
---

# Choicebox

A card-style selection component supporting both single-select (radio) and multi-select (checkbox) modes. Each option displays a label and optional description with a visual checkmark indicator.
