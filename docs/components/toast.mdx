...
3. `altText` – short description of an alternative way for users to acheive the desired action. This field is important for screen reader users who may not be able to access the toast easily, especially if it is time-sensitive.
