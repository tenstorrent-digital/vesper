...
Vesper is built on top of a set of design tokens corresponding to colors, spacing, radius, leading, tracking, shadows, strokes, and backgrounds. These tokens are exposed as css variables when you import the component styles into your application, and can also be used in tailwind utilities.
