...
A syntax-highlighted code block component powered by Shiki. Supports static code strings and streaming content, line numbers, copy-to-clipboard, and custom transformers. [View in Storybook]({`${storybookUrl}/code-block`})
