...
A compact, interactive element used for filtering, tagging, or toggling selections. Supports selected and disabled states, optional leading and trailing icons, and polymorphic rendering. [View in Storybook]({`${STORYBOOK_URL}/chip`})
