...
A card-style selection component supporting both single-select (radio) and multi-select (checkbox) modes. Each option displays a label and optional description with a visual checkmark indicator. [View in Storybook]({`${STORYBOOK_URL}/choicebox`})
