...
A collapsible content panel that toggles between expanded and collapsed states. Useful for organizing long-form content into manageable sections. [View in Storybook]({`${storybookUrl}/accordion`})
